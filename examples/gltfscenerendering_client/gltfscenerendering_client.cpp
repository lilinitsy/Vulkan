	...
	VulkanExampleBase(false, CLIENTWIDTH, CLIENTHEIGHT)
{
	...
	// Enable vkCreateRenderPass2 for 1.1 android
...
{
	const uint32_t multiview_layers = 2;
	...
	// Multiview Renderpass
	{
		...
		VkRenderPassCreateInfo2 renderpass_ci = {
		...
		VK_CHECK_RESULT(vkCreateRenderPass2KHR(device, &renderpass_ci, nullptr, &multiview_pass.renderpass));
	}
