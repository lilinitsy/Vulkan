...
const uint32_t DOWN_SHEIGHT = 900;
...
class VulkanExample : public VulkanExampleBase
{
  public:
	...
	*/
	...
	uint8_t left_servbuf[FOVEAWIDTH * FOVEAHEIGHT * sizeof(uint32_t)];
	uint8_t right_servbuf[FOVEAWIDTH * FOVEAHEIGHT * sizeof(uint32_t)];
